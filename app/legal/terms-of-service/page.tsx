      ...
      <div className="flex-1 lg:order-1">
        ...
        >
          ...
          <ul>
            ...
            <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Kamisoft Enterprises, Lagos, Nigeria.</li>
          ...
          <p>
            Your access to and use of the Service is also conditioned on Your acceptance of and compliance with the Privacy Policy of the Company. Our Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your personal information when You use the Application or the Website and tells You about Your privacy rights and how the law protects You. Please read Our <a href="/legal/privacy-policy" className="text-primary hover:underline">Privacy Policy</a> carefully before using Our Service.
          </p>

          <h2 id="links-other-websites">Links to Other Websites</h2>
          <p>
          ...
          <h2 id="severability-waiver">Severability and Waiver</h2>
          ...
          <h2 id="changes-terms">Changes to These Terms and Conditions</h2>
          <p>
