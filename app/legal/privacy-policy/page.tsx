    ...
    <div className="flex flex-col lg:flex-row gap-8">
      ...
      <div className="flex-1 lg:order-1">
        ...
        >
          ...
          <h2 id="collecting-using-data">Collecting and Using Your Personal Data</h2>

          <h3 id="types-data-collected">Types of Data Collected</h3>
          ...
          <p>
            For more information about the cookies we use and your choices regarding cookies, please visit our <a href="/legal/cookie-policy" className="text-primary hover:underline">Cookie Policy</a>.
          </p>

          <h3 id="use-personal-data">Use of Your Personal Data</h3>
          ...
          <h3 id="retention-personal-data">Retention of Your Personal Data</h3>
          <p>
          ...
          <h3 id="transfer-personal-data">Transfer of Your Personal Data</h3>
          <p>
          ...
          <h3 id="delete-personal-data">Delete Your Personal Data</h3>
          <p>
          ...
          <h3 id="disclosure-personal-data">Disclosure of Your Personal Data</h3>
          ...
          <h3 id="security-personal-data">Security of Your Personal Data</h3>
          <p>
