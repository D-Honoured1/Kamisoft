...
import { getTestimonialById, updateTestimonial } from "@/lib/queries/content-client"
...
export default function EditTestimonialPage({ params }: { params: { id: string } }) {
  ...
  async function loadTestimonial() {
    try {
      ...
      setFormData({
        ...
        project_year: testimonial.project_year,
  ...
  if (loadingData) {
    return (
      <div className="p-8 max-w-4xl mx-auto">
        <div className="flex items-center justify-center h-64">
          <div className="text-muted-foreground">Loading testimonial...</div>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground mt-1">Update client feedback</p>
      </div>
